...
categories:
 - C++课程笔记
abbrlink: c87f
date: 2022-03-07 13:35:48
index_img: 'https://gitee.com/zhen-wang-yang/drawing-bed/raw/master/imge/thumb-1920-683021.jpg'
---

## 1.  头文件

- c++当中头文件可以直接采用类名的方式直接包含，<font color='orange'>不需要.h</font>

- 如果想要包含C语言标准库中的头文件，可以采用.h方式包含，也可以采用去掉.h直接在头文件前面加个c (例如：<font color='orange'><cstring></font>)

- <font color='orange'>包含自定义头文件</font>，不可以采用缺少.h的方式写法(例如："myhead.h")

  

## 2.  入口函数

- c++中<font color='orange'>只支持int返回值类型</font>主函数
- c++中主函数的参数没什么要求，<font color='orange'>可以写也可以不写</font>。
...
3.省略的方式 调用空间中的成员
	using namespace 空间名;
	注意问题：省略多个前缀的时候，要注意的问题同名问题（二义性问题）
4.命名空间的嵌套
	剥洋葱
	作用：1.在一定程度上增加标志符的使用率
		  2.在大型项目开始可以有效避免起名冲突
*/
namespace mm1
{
...
![](https://gitee.com/zhen-wang-yang/drawing-bed/raw/master/imge/bs2nJO.png)
...
![](https://gitee.com/zhen-wang-yang/drawing-bed/raw/master/imge/bs2Vdx.png)
...
![](https://gitee.com/zhen-wang-yang/drawing-bed/raw/master/imge/bs2Ee1.png)

## 7.  答疑

<font color='orange'>auto与C语言auto区别？</font>
...
<font color='orange'>为什么char*类型创建要加const?</font>
...
![](https://gitee.com/zhen-wang-yang/drawing-bed/raw/master/imge/bs2Zo6.png)
...
![](https://gitee.com/zhen-wang-yang/drawing-bed/raw/master/imge/bs2mFK.png)
...
![](https://gitee.com/zhen-wang-yang/drawing-bed/raw/master/imge/bs2uWD.png)
...
![](https://gitee.com/zhen-wang-yang/drawing-bed/raw/master/imge/bs2MSe.png)
