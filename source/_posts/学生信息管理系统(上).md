...
cover: false
toc: true
index_img: 'https://gitee.com/zhen-wang-yang/drawing-bed/raw/master/imge/thumb-1920-61295.jpg'
mathjax: false
tags:
  - 学生信息管理系统
  - C语言
...
## <font color='cornflowerblue'>1.  声明函数</font>
...
## <font color='cornflowerblue'>2.  头文件，预处理，全局变量</font>
...
## <font color='cornflowerblue'>3.  main函数</font>
...
## <font color='cornflowerblue'>4.  登录界面</font>
...
## <font color='cornflowerblue'>5.  登录界面需要用到的链表结构体</font>
...
## <font color='cornflowerblue'>6.  获取控制台函数，可以指定位置显示</font>
...
## <font color='cornflowerblue'>7.  查找账号，密码函数</font>
...
## <font color='cornflowerblue'>8.  账号防呆，密码防呆函数</font>
...
## <font color='cornflowerblue'>9.  保存到文件，和从文件提取数据函数</font>
...
## <font color='cornflowerblue'>10.  修改密码函数</font>
...
## <font color='cornflowerblue'>11. 登陆功能实现</font>
...
## <font color='cornflowerblue'>12.  注册功能实现</font>
...
## <font color='cornflowerblue'>13.  (后门)管理员界面</font>
...
## <font color='cornflowerblue'>14.  管理员界面的数据显示</font>
...
## <font color='cornflowerblue'>15.  权限函数：（只限制学生就行，老师和管理员无区别）</font>
...
## <font color='cornflowerblue'>16.  日志文件：（可以知道哪行出现问题）</font>
...
## <font color='cornflowerblue'>17.  隐藏光标函数：</font>
...
## <font color='cornflowerblue'>18.  获取当前时间函数</font>
...
## <font color='cornflowerblue'>19.  清空缓冲区等待按键按下函数</font>

<font color='red'>还有代码中rewind(stdin);也是清空缓冲区效果</font>
...
## <font color='cornflowerblue'>20.  增删改查需要用到的链表结构体</font>
